...
import comment from './coponent/comment'
...
function App() {
  return (
    <div className="p-2">
      ...
      {comments.map(e => <comment>username ={e.username} userImagePath={e.userImagePath} commentText={e.commentText} likeNum={e.likeNum} replies={e.replies}></comment>)}

    </div>

  //ทำไมดึงcomponent มาไม่ได้ หนูงงมากเลยค่า หนูผิดตรงไหน TT 
    ...
    //         <span className='font-semibold text-lg'>Lapasrada Kumjulla 630610757</span>
    //       </div>
